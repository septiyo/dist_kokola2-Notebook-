...
$sql_cari_produk_id = " Select * from ( select * from (select item_name as NP, item_code as ICOD from push_item) as KK right join forecast on KK.ICOD = forecast.ITEM_CODE) 
    as MM where MM.ACCOUNT_ID = '$accid' and TRIWULAN = '$tri' and YEAR(TGL) = '$yearku' and MM.publish = '1'; ";
