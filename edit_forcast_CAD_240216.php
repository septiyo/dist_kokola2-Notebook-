...
$sql_cari_isi = "SELECT BULAN_INPUT, NAMA_DIST FROM kj
	WHERE TRIWULAN = '$tri' AND NAMA_DIST= '$_SESSION[USER]' GROUP BY BULAN_INPUT ";
        ...
        <table id="example" class="display order-column" cellspacing="0" width="100%">
		   ...
		   /* $sql_produk = "SELECT m_produk.`NAMA_PRODUK`,
			...
			while ($data_produk = mysqli_fetch_assoc($hasil_produk)) {
                            echo "<tr>";
                            echo "<th align='left'>$data_produk[NAMA_PRODUK]
								<input type='hidden' value='$data_produk[NAMA_PRODUK]' name='PRODUK[]'> </th>";
