  ...
  //});
    ...
    <div data-role="page" id="page1" data-theme="a">
        <div data-role="header">
            <h1>ORDER KIRIM HARI INI<?php //echo "<i>".$accid."</i>";?></h1>

            <h2>Kokola Distributor 2.5</h2><a href="pilih_pengiriman.php" target="_parent" class="ui-btn ui-btn-inline ui-icon-back ui-btn-icon-notext ui-corner-all">No text</a>
        </div>
<!-- dialog so-->
...
<div id="popup-tgl" data-role="popup" data-theme="a" ></div>
		...
		if ($bulanku == 01) 
		{
echo "<a href='report_kirim_next.php?BLN=02' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 2</a>
       <a href='report_kirim_next.php?BLN=03' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 3</a> ";
		}
		elseif ($bulanku == 02)
		{
echo "<a href='report_kirim_next.php?BLN=03' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 3</a>";	
		}
		elseif ($bulanku == 04)
		{
echo "<a href='report_kirim_next.php?BLN=04' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 4</a> <a href='report_kirim_next.php?BLN=05' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 5</a> ";	
		}
		elseif ($bulanku == 05)
		{
echo "<a href='report_kirim_next.php?BLN=05' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 5</a> ";	
		}
		elseif ($bulanku == 07)
		{
echo "<a href='report_kirim_next.php?BLN=07' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 7</a>  <a href='report_kirim_next.php?BLN=08' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 8</a> ";	
		}
		elseif ($bulanku == 08)
		{
echo "<a href='report_kirim_next.php?BLN=08' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 8</a>";	
		}
		elseif ($bulanku == 10)
		{
echo "<a href='report_kirim_next.php?BLN=10' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 10</a> <a href='report_kirim_next.php?BLN=11' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 11</a> ";	
		}
		elseif ($bulanku == 11)
		{
echo "<a href='report_kirim_next.php?BLN=11' target='_parent' data-role='button' class='ui-btn ui-btn-inline'>Bulan 11</a> ";	
		}
		?>
