                ...
                <table id="example"  class="order-column cell-border display" cellspacing="0" width="100%">
                  ...
                  /*  $sql_produk = "SELECT m_produk.`NAMA_PRODUK`,
                    ...
                    while ($data_produk = mysqli_fetch_assoc($hasil_produk)) {
                        ...
                        echo "<td align='right' class='bln_akhir'>$data_produk[BLN_AKHIR]<!--input type='text' name='bln_akhir[]' id='bln_akhir' class='bln_akhir' value='$data_produk[BLN_AKHIR]' --></td>";
                        echo "<td align='right' class='FORECAST'>$data_produk[FORECAST]<!--input type='text' name='FORECAST[]' id='FORECAST' class='FORECAST' value='$data_produk[FORECAST]'--></td>";
                        ...
                        echo "<td align='right' class='BULAN1'>$data_produk[BULAN1]<!--input type='text' name='BULAN1[]' style='min-width: 100px'   id='BULAN1' class='BULAN1' value='$data_produk[BULAN1]'   --></td>";
                        echo "<td align='right' class='BULAN2'>$data_produk[BULAN2]<!--input type='text' name='BULAN2[]' style='min-width: 100px'   id='BULAN2' class='BULAN2' value='$data_produk[BULAN2]'   --></td>";
                        echo "<td align='right' class='BULAN3'>$data_produk[BULAN3]<!--input type='text' name='BULAN3[]' style='min-width: 100px'   id='BULAN3' class='BULAN3' value='$data_produk[BULAN3]'   --></td>";
