 ...
 <ul data-role="listview" data-inset="true">
  ...
  <!-- </li>-->
   ...
   <li class="ui-field-contain">
       ...
       <div class="ui-widget">
        <input type="text" name="KATEGORI" id="KATEGORI" value="<?php echo $data_kj['KATEGORI']?>" placeholder="" maxlength="200" data-clear-btn="true" /></div>
   </li>
   <!--<li class="ui-field-contain">
    
       <label for="PASS">Keterangan</label>
        <input type="text" name="KOTA" id="KOTA" value="<?php //echo $data_kj['KET']?>" placeholder="" maxlength="200" data-clear-btn="true"/>
   </li>-->
