...
<form action="" method="post">
   ...
   <thead>
   <tr><th >No</th><th style='min-width:250px'>Nama</th><th>Kota</th><th>Total</th><th>ACTION</th></tr>
   </thead>
   <tfoot>
                        <tr bgcolor="#7fffd4">
                            <th width="50">&nbsp;</th>
...
$no = 1;
					...
					<td align='center'><a href='#popupBasic$idac'data-mini='true' data-position-to='window' data-rel='popup'  data-transition='flow'>Detail</a></td></tr>";
...
$sql_kj2 = "select * from(select * from (select account_id, item_code , qty, periode2 from order_kirim_wd) as CC left join (select ITEM_CODE as ii, NAMA_PRODUK from m_produk) as KK
 on KK.ii = CC.item_code) as GG where GG.account_id = '$idac'  and GG.periode2 = '$ttt' ";
