    ...
    if($_SESSION['HAK'] == "ADMIN") {
        ...
        <div data-role="page" class="type-interior" data-theme="f">
            ...
            <div data-role="content">
                ...
                <h2 align="center">KONFIRMASI Distributor ORDER HARI INI</h2>
               ...
               // error_reporting(0);
				...
				/*	$sql = "SELECT order_distributor.TGL,
					...
					GROUP BY order_distributor.ACCOUNT_ID";	*/
					...
					GROUP BY order_distributor.ACCOUNT_ID,FLAG,order_distributor.ID_ORDER";
				...
				<div style="text-align:center"><h2>Distributor yang sudah terjadwal namun belum order</h2></div>
				
				</table>


 <br><br>                <table id="example2" class="stripe row-border order-column" cellspacing="0" width="100%">
                    <thead>
                    <tr>
					    <!--th align="center">Date Time</th-->
                        <th align="center">Distributor</th>
        ...
        GROUP BY order_kirim_wd.ACCOUNT_ID";				   
