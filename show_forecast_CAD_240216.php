                ...
                <table id="example"  class="order-column cell-border display" cellspacing="0" width="100%">
                  ...
                  /*  $sql_produk = "SELECT m_produk.`NAMA_PRODUK`,
                    ...
                    while ($data_produk = mysqli_fetch_assoc($hasil_produk)) {
                        ...
                        echo "<tr>";
                        echo "<th align='left' width='400'>$data_produk[NAMA_PRODUK]</th>";

                        //echo "<td align='right' class='harga'> $data_produk[HARGA]</td>";
                        echo "<td align='right' class='bln_akhir'>$data_produk[BLN_AKHIR]</td>";
                        echo "<td align='right' class='FORECAST'>$data_produk[FORECAST]</td>";
                        echo "<td align='center'>$data_produk[PERSEN]</td>";
                        echo "<td align='right' class='BULAN1'>$data_produk[BULAN1]</td>";
                        echo "<td align='right' class='BULAN2'>$data_produk[BULAN2]</td>";
                        echo "<td align='right' class='BULAN3'>$data_produk[BULAN3]</td>";
