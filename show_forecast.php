...
//echo $jumlah_forcast;
        ...
        while ($n <= $jumlah_total_value) {
            ...
            if ($total_value[$n] != "") {
                ...
                $sql_kj = "UPDATE forecast SET TGL = '$tanggal',
    ...
    $sql_cari_isi = "SELECT * FROM forecast WHERE TRIWULAN = '$tri' AND NAMA_DIST= '$_SESSION[USER]' and publish = '1' AND TAHUN_INPUT = '$tahun'";
...
<!--                    <th width="100" align='center' class="header-lastmonth">Last 3 Month</th>-->
                        <th width="100" align='center' class="header-forecast">Forecast</th>
<!--                        <th width="100" align='center' class="header-persen"> % </th>-->
                  ...
                  /*  $sql_produk = "SELECT m_produk.`NAMA_PRODUK`,
                                 ...
                                 FROM m_produk
                                 LEFT JOIN forecast
                                 ON m_produk.`NAMA_PRODUK` = forecast.`NAMA_PRODUK` AND forecast.TRIWULAN = '$tri' AND forecast.NAMA_DIST = '$_SESSION[USER]'  ORDER BY NAMA_PRODUK ASC";*/

                      /* $sql_produk = "SELECT * FROM forecast WHERE NAMA_DIST = '$_SESSION[USER]' AND TRIWULAN = '$tri' ORDER BY NAMA_PRODUK ASC"; */
                     
					 $sql_produk = "SELECT *, m_produk.`NAMA_PRODUK` AS REV_NAMA_PRODUK FROM forecast
										INNER JOIN `m_produk` ON forecast.`ITEM_CODE` = `m_produk`.`ITEM_CODE`
										WHERE forecast.ACCOUNT_ID = '$_SESSION[USER]' AND forecast.TRIWULAN = '$tri' AND forecast.publish = '1' AND forecast.TGL = '$tgl'
										ORDER BY forecast.NAMA_PRODUK ASC;";
                    ...
                    while ($data_produk = mysqli_fetch_assoc($hasil_produk)) {
                        ...
                        echo "<tr>";
                        echo "<th align='left' width='350'>$data_produk[REV_NAMA_PRODUK]</th>";
...
<!--                        <th width="100" class="footer-lastmonth" align="Right">--><?php //echo number_format($jml_bln_akhir);?><!--</th>-->
                ...
                echo "<a href='print_sales.php?TRI=$tri&ACC=$_SESSION[USER]&TGL=$tgl&TAHUN=$tahun' data-role='button' target='_blank'>Print</a>";
