...
<div id="popup-tgl" data-role="popup" data-theme="a" ></div>
        ...
        <?php
$sql9x2 = "select SUM(BULAN2) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Jan-Feb-Mar' and YEAR(TGL) = '$yearku';";
		$query9x2=mysqli_query($mysqli, $sql9x2);
  		$data9x2=mysqli_fetch_array($query9x2);//) {
        $mi2 = $data9x2 ['BLN'];
		
$sql9x3 = "select SUM(BULAN3) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Jan-Feb-Mar' and YEAR(TGL) = '$yearku';";
		$query9x3=mysqli_query($mysqli, $sql9x3);
  		$data9x3=mysqli_fetch_array($query9x3);//) {
        $mi3 = $data9x3 ['BLN'];
		
$sql9x4 = "select SUM(BULAN1) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Apr-May-Jun' and YEAR(TGL) = '$yearku';";
		$query9x4=mysqli_query($mysqli, $sql9x4);
  		$data9x4=mysqli_fetch_array($query9x4);//) {
        $mi4 = $data9x4 ['BLN'];
		
$sql9x5 = "select SUM(BULAN2) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Apr-May-Jun' and YEAR(TGL) = '$yearku';";
		$query9x5=mysqli_query($mysqli, $sql9x5);
  		$data9x5=mysqli_fetch_array($query9x5);//) {
        $mi5 = $data9x5 ['BLN'];
		
$sql9x6 = "select SUM(BULAN3) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Apr-May-Jun' and YEAR(TGL) = '$yearku';";
		$query9x6=mysqli_query($mysqli, $sql9x6);
  		$data9x6=mysqli_fetch_array($query9x6);//) {
        $mi6 = $data9x6 ['BLN'];
		
$sql9x7 = "select SUM(BULAN1) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Jul-Aug-Sep' and YEAR(TGL) = '$yearku';";
		$query9x7=mysqli_query($mysqli, $sql9x7);
  		$data9x7=mysqli_fetch_array($query9x7);//) {
        $mi7 = $data9x7 ['BLN'];
		
$sql9x8 = "select SUM(BULAN2) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Jul-Aug-Sep' and YEAR(TGL) = '$yearku';";
		$query9x8=mysqli_query($mysqli, $sql9x8);
  		$data9x8=mysqli_fetch_array($query9x8);//) {
        $mi8 = $data9x8 ['BLN'];
		
$sql9x9 = "select SUM(BULAN3) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Jul-Aug-Sep' and YEAR(TGL) = '$yearku';";
		$query9x9=mysqli_query($mysqli, $sql9x9);
  		$data9x9=mysqli_fetch_array($query9x9);//) {
        $mi9 = $data9x9 ['BLN'];	
		
$sql9x10 = "select SUM(BULAN1) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Oct-Nov-Dec' and YEAR(TGL) = '$yearku';";
		$query9x10=mysqli_query($mysqli, $sql9x10);
  		$data9x10=mysqli_fetch_array($query9x10);//) {
        $mi10 = $data9x10 ['BLN'];
		
$sql9x11 = "select SUM(BULAN2) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Oct-Nov-Dec' and YEAR(TGL) = '$yearku';";
		$query9x11=mysqli_query($mysqli, $sql9x11);
  		$data9x11=mysqli_fetch_array($query9x11);//) {
        $mi11 = $data9x11 ['BLN'];
		
$sql9x12 = "select SUM(BULAN3) as  BLN from kj where NAMA_DIST = '$accid' and TRIWULAN = 'Oct-Nov-Dec' and YEAR(TGL) = '$yearku';";
