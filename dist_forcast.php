...
if($_SESSION['USER']) {
	...
	/*langsung simpan*/
	  ...
	  $(document).ready(function(){
        ...
        function checkConnection() {
			$.ajax({
				type:"post",
				url:"http://<?php echo $_SERVER['SERVER_NAME']; ?>/dist_kokola2/index-app.php",
  ...
  .highlightedRow { background-color: orange; }
	...
	/*Blockade*/
	 ...
	 $tahun_now = date('Y');
			$cek_block = "SELECT * FROM kj WHERE `TRIWULAN` = '$_SESSION[TRIWULAN]' 
			                   AND `ACCOUNT_ID` = '$_SESSION[ACCOUNT_ID]'
 							   AND `publish` = '1'
							   AND YEAR(TGL) = '$tahun_now';";
                    ...
                    <tr>
                        <td align="center" colspan="9" align='center'>
							...
							<select name='TRIWULAN' id='UBAH_TRIWULAN'>
							  ...
							  <option value='Feb-Mar-Apr' <?php if($_COOKIE['cookieName'] == "Feb-Mar-Apr"){echo 'selected="selected"';}?>>Feb-Mar-Apr</option>
							  <option value='Mar-Apr-May' <?php if($_COOKIE['cookieName'] == "Mar-Apr-May"){echo 'selected="selected"';}?>>Mar-Apr-May</option>
							  <option value='Apr-May-Jun' <?php if($_COOKIE['cookieName'] == "Apr-May-Jun"){echo 'selected="selected"';}?>>Apr-May-Jun</option>
							  <option value='May-Jun-Jul' <?php if($_COOKIE['cookieName'] == "May-Jun-Jul"){echo 'selected="selected"';}?>>May-Jun-Jul</option>
							  <option value='Jun-Jul-Aug' <?php if($_COOKIE['cookieName'] == "Jun-Jul-Aug"){echo 'selected="selected"';}?>>Jun-Jul-Aug</option>
							  <option value='Jul-Aug-Sep' <?php if($_COOKIE['cookieName'] == "Jul-Aug-Sep"){echo 'selected="selected"';}?>>Jul-Aug-Sep</option>
							  <option value='Aug-Sep-Oct' <?php if($_COOKIE['cookieName'] == "Aug-Sep-Oct"){echo 'selected="selected"';}?>>Aug-Sep-Oct</option>
							  <option value='Sep-Oct-Nov' <?php if($_COOKIE['cookieName'] == "Sep-Oct-Nov"){echo 'selected="selected"';}?>>Sep-Oct-Nov</option>
							  <option value='Oct-Nov-Dec' <?php if($_COOKIE['cookieName'] == "Oct-Nov-Dec"){echo 'selected="selected"';}?>>Oct-Nov-Dec</option>
							  <option value='Nov-Dec-Jan' <?php if($_COOKIE['cookieName'] == "Nov-Dec-Jan"){echo 'selected="selected"';}?>>Nov-Dec-Jan</option>
							  <option value='Dec-Jan-Feb' <?php if($_COOKIE['cookieName'] == "Dec-Jan-Feb"){echo 'selected="selected"';}?>>Dec-Jan-Feb</option>

							</select>
							<h3 class="blink">Jangan Lupa TRIWULAN harus Dipilih Sampai Kolom Bulan Terisi Nama Bulan Nya, Jangan Lupa..!</h3>
                        </td>
