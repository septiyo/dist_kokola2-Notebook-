...
if($_SESSION['USER']) {
    ...
    <div data-role="page" class="type-interior" data-theme="f">
        <div data-role="header" data-position="fixed" data-tap-toggle="false">        	
        	<a href="home.php" data-icon="arrow-l" data-role="button" target="_parent">Back</a>
            <h1>Forecast FORM</h1>
        ...
        <div data-role="content">
            <div align="center" style="text-shadow:none;">
            	<div style="font-weight:bold;">FORECAST<br><br>
				[ Note: FORECAST disortir dan digroupkan berdasar TRIWULAN dan TGL INPUT, Jadi jika ada yang dobel akan terlihat. ]
				</div><br>
           ...
           // $cek_block = (($month !== "Mar") || ($month !== "Jun") || ($month !== "Sep") || ($month !== "Dec"));
            ...
            <table border="0" cellpadding="1" cellspacing="0" align="left">
                <tr>
                    ...
                    <td>
<!--  --><?php //echo "<a href='dist_forcast_lain.php?BULAN=$_SESSION[TRIWULAN]' data-role='button' data-ajax='false' target='_parent'>Buat Forecast Triwulan Lain</a>"; ?>
                    </td>
					<!--td><?php echo "<a href='frame.php' data-role='button' data-ajax='false' target='_parent'>Add Forecast</a>"; ?></td-->
					<td><!--?php echo "<a href='dist_forcast.php' data-role='button' data-ajax='false' target='_parent'>Add Forecast</a>"; ?--></td>
...
<!--                    <td align="center">REVISI</td>-->
		...
		$sql_kj = "SELECT * FROM forecast WHERE NAMA_DIST = '$_SESSION[USER]' AND publish = '1' GROUP BY TRIWULAN, TGL ORDER BY ID DESC";
                ...
                while ($data_kj = mysqli_fetch_array($hasil_kj)) {
                    ...
                    echo "<td align='center'><a href='show_forecast.php?TRI=$triwulan&TAHUN=$tahun&TGL=$tgl'
...
//
//
//                            echo "<td><a href='edit_forcast.php?TRI=$triwulan&TGL=$tgl'
