    ...
    <div data-role="page" class="type-interior" data-theme="f">
        ...
        <div data-role="content">
            <div align="center" style="text-shadow:none;">
            	<div style="font-weight:bold;">KJ / FORECAST<br><br>
				[ Note: KJ disortir dan digroupkan berdasar TRIWULAN dan TGL INPUT, Jadi jika ada yang dobel akan terlihat. ]
				</div><br>
		...
		$sql_kj = "SELECT * FROM kj WHERE NAMA_DIST = '$_SESSION[USER]' AND publish = '1' GROUP BY TRIWULAN, TGL ORDER BY ID DESC";
