...
$(document).ready(function(e) {
	...
	var tinggi = $(window).height()-t_minus-t_minus-t_minus-43;
	var jml_order = 0;
	var jml_kubik = 0;
	...
	oTable = $("#tb_order").dataTable({
		"language": {
			...
			"emptyTable": "Order tanpa KJ, silahkan tambah order",
...
$sqlCek = "select * from order_distributor where ACCOUNT_ID = '".$account_id."'";
$myCek = mysql_query($sqlCek);
if ($DataCek = mysql_fetch_assoc($myCek)) {
	$pernah = 'ya';
}
else {
	$pernah = 'tidak';	
            ...
            <div id="div_order">
                ...
                <table id="tb_order" class="display cell-border compact" cellspacing="0" width="100%">
                    ...
                    <tfoot>
                        ...
                        <tr>
                        	<th colspan="5" align="left" valign="top" style="position:relative;">
                    ...
                    <tbody>
                   		<!--<tr nama='baris'>
                        	<td class="nama_produk" style="min-width:100px;">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>                        
