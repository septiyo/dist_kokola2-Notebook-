                ...
                <table id="tb_popup" class="display cell-border compact" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr style="color:#066">
                            ...
                            <td align="center">
                            	<span class="code_produk"><?php echo $dataProduk['ITEM_CODE'];?></span>
                            	<span class="id_produk" style="display:none;">
								<?php echo $dataProduk['ID'];?></span></td>
            ...
            <div id="div_order">
                ...
                <table id="tb_order" class="display cell-border compact" cellspacing="0" width="100%">
                    ...
                    <tfoot>
                        ...
                        <tr>
                        	<?php
							$sqlBlink = "select KALIMAT from kata_sakti_f";
