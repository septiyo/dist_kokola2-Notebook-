...
$(document).ready(function () {
	...
	$("div.toolbar").html('<b><input type="text" id="cari" style="margin:10px 0; padding:4px;" placeholder="Cari"></b>');
...
if(isset($_POST['CONFIRM'])){	
	...
	if($jos == "2"){
		...
		$sql_ubah_kirim_wd = "UPDATE order_kirim_wd SET  FLAG = '4'
			WHERE ACCOUNT_ID = '$account_idne' AND periode2 = '$today_database'";
...
<div data-role="page"  id="page1" class="type-interior" data-theme="f">
    ...
    <div data-role="content" id="top">
		<h2 align="center">KONFIRMASI ORDER DETAIL<br><?php if($jos == 1){echo "<div style='color:yellow'>CODE 1</div>";}else{echo "<div style='color:red'>CODE 2</div>";}?></h2>
