...
//echo $id_order;
    ...
    <div class="ui-block-b" align="right">
        ...
        <tr>
        <td>
		    <?php if($jos != 4){echo "<button id='tambah' data-role='button' class='ui-btn ui-btn-inline' data-theme='f'>Tambah Order</button>";}?></td>
 ...
 <input name="ID_ORDER" id="un" value="<?php echo $id_order;?>"  data-theme="a" type="hidden">
                <?php if($jos != '4'){echo "<input type='submit' name='CONFIRM' value='CONFIRM' />";}?>
                </form>
		<br><br>
