    ...
    <div data-role="page" class="type-interior" data-theme="f">
        ...
        <div data-role="content">
            ...
            <table id="example" class="display" cellspacing="0" width="100%">
                ...
                $sql_kj = "SELECT  kj.TGL,
                                   kj.NAMA_DIST,
                                   kj.TRIWULAN,
                                 user.NAMA 
                                  FROM kj,user
                                   WHERE kj.ACCOUNT_ID = user.ACCOUNT_ID
                                  GROUP BY TRIWULAN, NAMA_DIST ORDER BY user.ID DESC";
                ...
                while ($data_kj = mysqli_fetch_array($hasil_kj)) {
                    ...
                    echo "<td align='center'><a href='detail_kj_admin.php?DIST=$nama_dist&TRI=$triwulan' data-ajax='false' data-role='button'>DETAIL</a>                  </td>";
