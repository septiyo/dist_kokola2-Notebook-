...
//echo $jumlah_forcast;
        ...
        while ($n <= $jumlah_total_value) {
            ...
            if ($total_value[$n] != "") {
                ...
                $sql_kj = "UPDATE  kj_f SET   TGL = '$tanggal',
    ...
    $sql_cari_isi = "SELECT * FROM kj_f WHERE TRIWULAN = '$tri' AND NAMA_DIST= '$_SESSION[USER]'";
 ...
 <!--th width="30">Harga</th-->
                ...
                <table id="example"  class="order-column cell-border display" cellspacing="0" width="100%">
                  ...
                  /*  $sql_produk = "SELECT m_produk.`NAMA_PRODUK`,
                                 ...
                                 FROM m_produk
                                 LEFT JOIN kj_f
                                 ON m_produk.`NAMA_PRODUK` = kj_f.`NAMA_PRODUK` AND kj_f.TRIWULAN = '$tri' AND kj_f.NAMA_DIST = '$_SESSION[USER]'  ORDER BY NAMA_PRODUK ASC";*/

                      $sql_produk = "SELECT * FROM kj_f WHERE NAMA_DIST = '$_SESSION[USER]' AND TRIWULAN = '$tri' ORDER BY NAMA_PRODUK ASC";
