...
<div data-role="page" data-theme="a">
	<div data-role="header" data-position="fixed" data-tap-toggle="false">
    	...
    	<h1 style="width:170px;margin:auto;">Pilih Modern Outlet</h1>
    </div>
			...
			while ($dataDist = mysql_fetch_assoc($myDist)) {
				...
				?>
					<tr>
						...
						<td><a href="cmo_forcast.php?ACC_ID=<?php echo $acc_id;?>" style="text-decoration:none;" data-ajax="false">
