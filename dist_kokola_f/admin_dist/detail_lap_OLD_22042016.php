...
//echo "<br>".$bj;
 ...
 $sqlshow = " select *, SATU.JML_ORDER - DUA.TARGET as SISA1 ,
         ...
         from order_confirm where YEAR(TGL_ORDER) = '$poku' group by ITEM_CODE, ACCOUNT_ID , YEAR(TGL_ORDER) ) 
             as SATU,        
        ...
        group by MONTH(OL.periode2),YEAR(OL.periode2), OL.ACCOUNT_ID, OL.item_code)as KH 
