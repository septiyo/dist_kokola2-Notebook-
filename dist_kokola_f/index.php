...
if(isset($_POST['LOGIN'])) {
	...
	/*$query = "SELECT * FROM user,
		...
		$query="SELECT user_f.ACCOUNT_ID AS account_id_user, 
         user_f.PASS,
         user_f.HAK,
         user_f.NAMA,
         user_f.KOTA,
       ...
       FROM `user_f`
               LEFT JOIN push_distributor  ON `user_f`.ACCOUNT_ID = push_distributor.ACCOUNT_ID 
               WHERE user_f.USER = '$nama'
               AND user_f.PASS = '$pass'";	  
/*echo $query;
exit;*/			   
