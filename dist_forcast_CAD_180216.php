...
if($_SESSION['USER']) {
    ...
    <!--<script src="order/js/dataTables.fixedColumns.min.js"></script>-->
        ...
        <div data-role="content">
            <form id="formx" method="post" action="simpan_kj.php" data-ajax="false">
                ...
                <table id="example"  class="display order-column display stripe" cellspacing="0" width="100%">
                    ...
                    <?php
					$total_last_month = "";
                    $sql_produk = "SELECT * FROM m_produk WHERE HARGA <> 0 AND ITEM_CODE <> 0 ORDER BY NAMA_PRODUK ASC";
                    ...
                    while ($data_produk = mysqli_fetch_assoc($hasil_produk)) {
						 ...
						 /*$sql_forcastx = "SELECT SUM(qty) AS total_last_month FROM order_kirim 
										 ...
										 /*
								SELECT SUM(qty) AS total_last_month,
                                ACCOUNT_ID,item_code
                                  FROM order_kirim 
				             WHERE periode1 = '2015-12-01'
                			 AND flag = 1
                			 group by ACCOUNT_ID
                        ...
                        echo "<td align='center'><input type='text' name='PERSEN[]' style='min-width: 70px' class='PERSEN' readonly placeholder='...' ></td>";
