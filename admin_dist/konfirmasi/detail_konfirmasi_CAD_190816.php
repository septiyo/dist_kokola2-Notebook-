...
/*	                        echo "<td align='center'><input type='text' value='$data[qty]' class='QTY_CONFIRM' name='QTY_CONFIRM[]'> </td>";	*/
                        ...
                        echo "<td align='center'><div class='KUBIKASI_CONFIRM'>$kubikasi_total2</div>
							<input type='text' name='KUBIKASI_BELUM_DIOLAH[]' class='nilai_kubik' value='$jml_kubik'>
                      <input type='text' name='KUBIKASI_DATABASE[]' id='KUBIKASI' class='KUBIKASI' value='$kubikasi_total2'>
                            <input type='text' name='KUBIKASI_OLAHAN[]' id='KUBIKASI_OLAHAN' class='KUBIKASI_OLAHAN'>
 ...
 <input name="ID_ORDER" id="un" class="ID_ORDER" value="<?php echo $id_order;?>"  data-theme="a" type="hidden">
		...
		<a href="#popupdel" data-role="button" id="bt_hapus" data-rel="popup" data-position-to="window">HAPUS</a>
