					...
					//$("#SUBMIT").on("click", function(e){
					 ...
					 //$("#BULAN").on("change", function(e){
                       $("#TAHUN").on("change", function(e){
		                ...
		                localStorage.setItem("tahunx", tahun);
	...
	$.getJSON("action_ppic.php", {BULAN: bulan, TAHUN: tahun}, function(res){
			...
			// alert(tri);
			 ...
			 var trHTML = '';
			   $.each(res, function (i, item) {
				trHTML += '<tr><td align=center>' + item.TRIWULAN + '</td><td align=center><!--a href="detail_barang.php?KATE='+ item.KATEGORI +'&TRI='+ bulan +'" target="_parent"-->' + item.KATEGORI + '<!--/a--></td><td align=center>' + item.NAMA_PRODUK + '</td><td align=center>' + item.BULAN1 + '</td><td align=center>' + item.BULAN2 + '</td><td align=center>' + item.BULAN3 + '</td></tr>';
	    ...
	    //cari total
					...
					$.getJSON("cari_total.php", {BULAN: bulan, TAHUN: tahun}, function(dor){
							...
							/*   alert(dor[0].BULAN1);
							  ...
							  var total_jendral = Number(bulanx1) + Number(bulanx2) + Number(bulanx3);

							  $('.total_jendral').text(total_jendral);
         ...
         /*Digawe Print*/
            ...
            $('#JOS').click(function() {
              ...
              if(BULANX == ""){
                ...
                alert('Anda belum pilih Bulan..! atau tahun..!');
                   ...
                   //window.location='print.php?DATANE=' + NILAI;
						 ...
						 window.location='print.php?BULAN=' + BULANX + '&TAHUN=' + TAHUNX;
              }
...
<!--                </div>-->
                 ...
                 <select name="TAHUN" id="TAHUN">
                   ...
                   <?php
					   ...
					   WHILE($jos<=2026){
						...
						echo "<option value='$jos'>$jos</option>";   
						 $jos++;  
					    }//end
			...
			<table id='gozaimas'>
             ...
             <b>Total:</b>
             <div class="ter"><h2><div class="total_jendral"></div></h2></div>
<br><br>
