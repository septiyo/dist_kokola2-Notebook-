        ...
        <div data-role="page" class="type-interior" data-theme="f">
            ...
            <div data-role="content">
               ...
               #error_reporting(0);
				...
				echo "<form action='list_jadwal_kirim.php' method='post' id='form1' data-ajax='false'>
				<table border='0' align='center'>
					<tr>
						<td align='center'>
							
								<input style='text-transform:none;'  class='button_date'  type='text' placeholder='From date' size='15' class='required'  id='from' name='from' readonly />
						</td>
						...
						<td align='center'>
								...
								<input style='text-transform:none;'  class='button_date'  size='15' type='text' placeholder='To Date' class='required' id='to' name='to' readonly />
						</td>
					</tr>
					<tr>
			...
			echo "<tr>
				...
				for($e=0;$e<=$rangeDay;$e++) {
					...
					if($datajmlorder['TOTAL_ORDER']=='') {
						...
						echo "
							<div data-role='popup' id='popup$idacc$tgljadi' class='ui-content' data-theme='a'>
							<a href='#' data-rel='back' class='ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right'>
								Close
							</a>									
							<div class='header' data-role='header'>
