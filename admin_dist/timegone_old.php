...
<div align="center"><strong>Input Time Gone</strong></div>
<?php
session_start();
error_reporting(0);
include "../koneksi.php";
...
if(isset($_POST['EDIT']))  {
  ...
  $tg = $_POST['tg'];
	   ...
	   $sql_del = "INSERT into hari_kerja SET JUMLAH_HARI = '$tg',
  ...
  if($hasil_del){
            ...
            echo "<script>alert('Berhasil'); window.location.href = 'timegone.php'</script>";
        }
        else{
...
$sql_kj = "SELECT * FROM hari_kerja where ID = (select MAX(ID) from hari_kerja) ";
                    $hasil_kj = mysqli_query($mysqli, $sql_kj);
                    $data_kj = mysqli_fetch_array($hasil_kj);
					$harikerja = $data_kj['JUMLAH_HARI'] ;
?>

   <form method="post" action="timegone.php" id="formku" >
   
 <ul data-role="listview" data-inset="true">
        <li class="ui-field-contain">
    
       <label for="USER">Jumlah Hari Kerja</label>
        <input type="text" name="tg" id="tg" placeholder=""  value="<?php echo $harikerja?>" maxlength="5" data-clear-btn="false" />
    </li>
    <!-- <li class="ui-field-contain">-->
         ...
         <li class="ui-body ui-body-b" >
          ...
          <div class="ui-block-a">
            <!--<button id="btnCancel" data-theme="a" 
              ...
              <a href="home_admin.php" class="ui-btn ui-icon-back ui-btn-icon-left ui-corner-all" target="_parent" >Back</a>
          ...
          <div class="ui-block-b">
            ...
            <button class="ui-btn ui-icon-check ui-btn-icon-left ui-corner-all" name="EDIT" value="Edit" onclick="return confirm('Apakah ingin edit data ini?');")>Save</button>  
          </div>
