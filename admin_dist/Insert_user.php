...
<div align="center"><strong>Add User</strong></div>
<?php
session_start();
error_reporting(0);
include "../koneksi.php";
...
if(isset($_POST['EDIT']))  {
  ...
  $kota = $_POST['KOTA'];
	   ...
	   $sql_del = "INSERT into user SET USER = '$user',
                                        PASS = '$pass',
                                        HAK = '$hak',                           
                                        NAMA  = '$nama',
                                        KOTA  = '$kota'
...
?>
   ...
   <form method="post" action="insert_user.php" id="formku" >
   
 <ul data-role="listview" data-inset="true">
        <li class="ui-field-contain">
    
       <label for="USER">Username </label>
        <input type="text" name="USER" id="USER" placeholder=""  value="" maxlength="30" data-clear-btn="true"/>
    </li>
     <li class="ui-field-contain">
