...
if($_SESSION[HAK] == "ADMIN") {
	...
	<ul data-role="listview" data-inset="true">
			...
			<li><a href="timegone.php" target="_parent">Input Time Gone</a></li>
			<li><a href="admin_kj.php" target="_parent">KJ / FORECAST</a></li>
			<li><a href="kirim_now.php" target="_parent">Jadwal Kirim Hari ini</a></li>
			<li><a href="set_banner.php" target="_parent">Set Banner</a></li>
			<li><a href="order_distributor.php" target="_parent">Order Distributor</a></li>
			<!-- <li><a href="konfirmasi/konfirmasi_order.php" target="_parent">Konfirmasi Order Hari ini</a></li> -->
			<li><a href="konfirmasi/konfirmasi_orderx.php" target="_parent">Konfirmasi Order Hari ini</a></li>
			<li><a href="konfirmasi/konfirmasi_return.php" target="_parent">Pengembalian Konfirmasi</a></li>
			<li><a href="list_total_kj.php" target="_parent" data-ajax='false'>Total Forecast Bulanan</a></li>
