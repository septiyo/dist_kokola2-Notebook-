...
?>
 ...
 <ul data-role="listview" data-inset="true">
       ...
       <label for="USER">Nama Produk </label>
        <input type="text" name="USER" id="USER" placeholder=""  value="<?php echo $data_kj['NAMA_PRODUK']?>"maxlength="200" data-clear-btn="false" /><input type="hidden" name="IDD" value="<?php echo $unm ?>" >
    </li>
