...
$isi.='<div data-role="collapsible" data-filtertext="'.$tes1['nama_label'].'" >
...
foreach($hasil as $row){
	...
	$isi.='
        <div data-role="collapsible" data-filtertext="'.$row['NAMA_PRODUK'].'">
            ...
            <ul data-role="listview" data-inset="false">
                ...
                <li>   
                <div class="ui-grid-a">
                    <div class="ui-block-a"><input name="FORECAST[]" class="FORECAST value="" placeholder="Forecast" type="number" style="background-color: #363232;color: #00ceff;">
...
$hasil = mysqli_query($mysqli, $sql);
$isi.='<div data-role="collapsible" data-filtertext="Lain-lain" >
            <h3>Lain-lain</h3>
            <ul data-role="listview" data-inset="false" style="padding-left:10px;padding-right:10px">
