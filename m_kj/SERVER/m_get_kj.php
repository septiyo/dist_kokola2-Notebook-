        ...
        <div data-role="collapsible" data-filtertext="'.$row['NAMA_PRODUK'].'" class="colep_2">
            ...
            <ul data-role="listview" data-inset="false">
                ...
                <div class="ui-grid-a">
                    ...
                    <input type="hidden" class="ITEM_NAME" value="'.$row['NAMA_PRODUK'].'" />
                    <input type="hidden" class="bln_akhir" value="'.$total_last_month.'" />    
                    </div>
                  ...
                  <div class="ui-grid-b">
                    <div class="ui-block-a"><input class="BULAN1" value="" placeholder="Bulan 1" type="number" style="background-color: #363232;color: #00ceff;"></div>
                    <div class="ui-block-b"><input class="BULAN2" value="" placeholder="Bulan 2" type="number" style="background-color: #363232;color: #00ceff;"></div>
                    <div class="ui-block-c"><input class="BULAN3" value="" placeholder="Bulan 3" type="number" style="background-color: #363232;color: #00ceff;" readonly></div>
                </div>
                </li>
       ...
       <div data-role="collapsible" data-filtertext="'.$row['NAMA_PRODUK'].'" class="colep_2">
            ...
            <ul data-role="listview" data-inset="false">
                ...
                <div class="ui-grid-b">
                    <div class="ui-block-a"><input class="BULAN1" value="" placeholder="Bulan 1" type="number" style="background-color: #363232;color: #00ceff;"></div>
                    <div class="ui-block-b"><input class="BULAN2" value="" placeholder="Bulan 2" type="number" style="background-color: #363232;color: #00ceff;"></div>
                    <div class="ui-block-c"><input class="BULAN3" value="" placeholder="Bulan 3" type="number" style="background-color: #363232;color: #00ceff;"></div>
                </div>
                </li>                
            </ul>
        </div>                    
