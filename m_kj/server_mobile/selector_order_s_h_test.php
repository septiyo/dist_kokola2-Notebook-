...
for($i = 0;$i<count($sal_id);$i++){
	...
	if(mysql_num_rows($ress) > 0){
		...
		while($row = mysql_fetch_array($result)){
			...
			$message = $ACCOUNT_ID." - ".$NAMA."";

		}
		
		$to      = 'dmsMgGx5baw:APA91bGX391hDcwUq9tVMjoCrTe-jpxoUig_z52_KRuLNNjdH8_SEKjeYAnxc47nJhGYb5afXQ7xHkgn159VwOSLMp9YZv3UIUIDmgwGg2EwKeQpFJnTNrDKVLP8LmIUuPI7Kfw90Vy0';
